...
Vector3.prototype = {
  ...
  length: function() {
    ...
    // magnitude = sqrt(x^2 + y^2 + z^2); call Math.sqrt for square root
  ...
  lengthSqr: function() {
    ...
    //lengthSqr = Math.abs(length()) ** 2;
    lengthSqr = ((this.x ** 2) + (this.y ** 2) + (this.z ** 2));
  ...
  dot: function(other) {
    ...
    // This should NOT change the values of this.x, this.y, and this.z
    dotProduct = ((this.x*other['x']) + (this.y*other['y']) + (this.z*other['z']))
    return dotProduct;
  },
